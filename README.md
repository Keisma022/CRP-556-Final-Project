...
---------------------------------------------------------------------------------------------------
City boundary AOI (in data/boundaries/)

NLCD impervious rasters (only included if folder size allows; otherwise hosted externally)
...
4. Provide required inputs
   		(any combination of year pairs, 2001,2006 or 2001,2006,2011, or for all pairs 2001,2006,2011,2016,2021
5. Outputs are generated automatically and put into outputs/maps
